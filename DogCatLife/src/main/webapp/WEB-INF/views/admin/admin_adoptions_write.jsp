...
//-->
				...
				<form id="frm" action="admin_adoptions_write_ok.mysql" method="post" enctype="multipart/form-data">					
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="AWbbs_view_table border">
						<tr> <td colspan="2" style="height:25; padding:5px">제목   :  <input type="text" name="subject" value="" style="width:650px; height:25px;"/></td></tr>					
