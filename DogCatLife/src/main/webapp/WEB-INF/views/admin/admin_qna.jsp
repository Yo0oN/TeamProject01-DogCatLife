...
<%
   ...
   if (qnaLists.size() == 0) {
      ...
      for ( int i=0; i < recordPerPage; i++) {
         ...
         sbHTML.append("<tr>");
         if(aseq.equals("")){
            sbHTML.append("<td align=\"center\"><form style='margin:0;'><input type='hidden' name='idx' value='Q"+seq+"'><input type='checkbox' name='select_checkbox'></form></td>");
         }else{
            sbHTML.append("<td align=\"center\"><form style='margin:0;'><input type='hidden' name='idx' value='A"+aseq+"'><input type='checkbox' name='select_checkbox'></form></td>");
         }
      ...
      <tbody>
         ...
         <div class="bbs_button top10">
            <div class="bbs_btn_left">
               ...
               <button type='button' class='h22 t4 small icon gray' onClick="delBbsNewBbs('admin_qna_multidelete.mysql', '<%=seq%>');"><span class='icon_x'></span>선택삭제</button>
            </div>
         </div>      
         <div class="top5">
                        ...
                        <tr>
                           <%
                              ...
                              if( cpage <= blockPerPage ){                                 
                                 ...
                                 /* out.println("<a href='admin_qna.mysql?cpage=1'>");
                                 out.println("<img src='./resources/assets/img/admin/btn_prev2.gif' align='absmiddle' border=0'>");
                                 out.println("</a>"); */
                                 out.println("</td>");
                              } else{                                 
                                 out.println("<td width='22' height='50'>");
                                 out.println("<a href='admin_qna.mysql?cpage="+(cpage-5)+"&codeopt=flag&sdate=&edate=&searchopt=&searchkey='>");                                 
                                 out.println("<img src='./resources/assets/img/admin/btn_prev2.gif' align='absmiddle' border=0'>");
                                 out.println("</a>");
                                 out.println("</td>");
                              }
                              ...
                              if( cpage == 1 ){                                                         
                                 ...
                                 out.println("<td width='22'>");
                                 out.println("<a href='admin_qna.mysql?cpage="+(cpage-1)+"&codeopt=flag&sdate=&edate=&searchopt=&searchkey='>");                                 
                                 out.println("<img src='./resources/assets/img/admin/btn_prev.gif' align='absmiddle' border=0'>");
                                 out.println("</a>");
                                 out.println("</td>");                              
                              }
                              ...
                              for(int i=startBlock; i<=endBlock; i++){
                                 if( cpage == i ){
                                    //out.println("<b>["+i+"]</b>");
                                    out.println("<a href='admin_qna.mysql?cpage=" + i + "&codeopt=flag&sdate=&edate=&searchopt=&searchkey='> [" + i + "] </a>");
                                 }else{
                                    out.println("<a href='admin_qna.mysql?cpage=" + i + "&codeopt=flag&sdate=&edate=&searchopt=&searchkey='>" + i + "</a>");
                                 }
                              }
                              ...
                              if( cpage == totalPage ){                              
                                 ...
                                 /* out.println("<a href='admin_qna.mysql?cpage="+totalPage+"'>");
                              ...
                              if( cpage/blockPerPage >= 0 ){                                 
                                 ...
                                 out.println("<td width='22' align='right'>");
                                 out.println("<a href='admin_qna.mysql?cpage="+(startBlock+blockPerPage)+"&codeopt=flag&sdate=&edate=&searchopt=&searchkey='>");
                                 out.println("<img src='./resources/assets/img/admin/btn_next2.gif' align='absmiddle' border='0'>");
                                 out.println("</a>");
                                 out.println("</td>");
                              }
