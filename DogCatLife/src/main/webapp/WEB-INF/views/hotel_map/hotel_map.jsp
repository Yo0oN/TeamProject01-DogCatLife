...
<body
				...
				<div class="section-content">
					<div class="row">
						<div class="col-md-12 xs-text-center">
							<h3 class="text-theme-colored font-36">위치 찾기</h3>
								...
								<div class="col-md-12">
									<div class="blog-posts single-post">
										<article class="post clearfix mb-0">
											<div class="entry-title pt-0 text-center">
												<h3 style="margin:20px 0;border-bottom:1px dashed #808080;display:inline-block">근처 호텔 검색</h3>
											</div>
											<div class="col-12 entry-meta pb=10 boarder-bottom-gray">
												<div class="map_wrap">
													<div id="map"
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=5a5d09c905eb556303eeef3a6fb464ea&libraries=services"></script>
	<script>
		// 마커를 담을 배열입니다
		var markers = [];
		...
		function searchPlaces() {
			...
			var keyword = document.getElementById('keyword').value + "애견호텔";
