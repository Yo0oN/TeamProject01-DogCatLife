...
(function($) {
    ...
    THEMEMASCOT.initialize = {
        ...
        init: function() {
            ...
            THEMEMASCOT.initialize.TM_loginModal();
        ...
        /* ---------------------------------------------------------------------- */
        TM_loginModal: function() {
            var ajaxLoadContent = true;
            if( ajaxLoadContent ) {
                $.ajax({
                    url: "/resources/soledot/jsp/fo/loginmodal.jsp",			//---실서버용
//                    url: "/medisvc/resources/soledot/jsp/fo/loginmodal.jsp",
        ...
        TM_demoSwitcher: function() {
            ...
            if( showSwitcher ) {
                $.ajax({
                    url: "http://thememascot.net/demo/html/health-beauty/medical/medinova-html/v3.2/demo/color-switcher/style-switcher.html",
                    success: function (data) { $('body').append(data); },
                    dataType: 'html'
                });
            }
...
//            20190314 추가 data-text-align="center"로 센터로 정렬할 수 있으나. 다른 우선값이 잇을경우 적용되지 않음...
            $('[data-text-align]').each(function() {
